...
// export const iidxes = {"isFile":8,"file":{"fileName":10,"protocol":9},"isEmail":2,"email":{"protocol":3,"local":4,"host":5},"isURL":11,"url":{"TLD":[18,6],"protocol":[15,22],"host":[17],"ipv4":19,"byProtocol":13,"port":21,"protocolWithDomain":12,"path":24}};
...
const fqdn = `(((${protocol})?(${domain}|${ipv4})(?=\\b|_)${port})|(?:${confirmedByProtocol}))`;
export const url = `(${fqdn})${path}?`;
export const ipv4WithPortRegex = `${ipv4}${port}`;
export const ipv6WithPortRegex = `${ipv6}${port}`;
export const ipRegex = new RegExp(`^(${ipv4}|${ipv6})$`, 'i');
export const urlRegex = new RegExp(`^(${url})$`, 'i');
export const chineseRegex = new RegExp(`[\u4e00-\u9fa5|\u3002|\uff1f|\uff01|\uff0c|\u3001|\uff1b|\uff1a|\u201c|\u201d|\u2018|\u2019|\uff08|\uff09|\u300a|\u300b|\u3008|\u3009|\u3010|\u3011|\u300e|\u300f|\u300c|\u300d|\ufe43|\ufe44|\u3014|\u3015|\u2026|\u2014|\uff5e|\ufe4f|\uffe5]`, 'ig');
export const textToUrlRegex = new RegExp(
  `(${ipv4WithPortRegex}|${ipv6WithPortRegex})|(${url})`,
  'ig',
);
